      ...
      children: [
        TabBar(
          ...
          tabs: tabs
              .map(
                (tab) => Tab(
                  icon: Text(tab, style: Theme.of(context).textTheme.headlineSmall!.copyWith(fontWeight: FontWeight.bold)),
                ),
              )
              .toList(),
        ),
              ...
              children: tabs
                  .map((tab) => ListView.builder(
                        ...
                        itemBuilder: ((context, index) {
                          return InkWell(
                            onTap: () {
                              Navigator.pushNamed(context, SingleArticleScreen.routeName, arguments: articles[index]);
                            },
                            child: Row(
                              children: [
                                ImageContainer(
        ...
        children: [
          ...
          TextFormField(
            decoration: InputDecoration(
                ...
                suffixIcon: const RotatedBox(quarterTurns: 1, child: Icon(Icons.tune, color: Colors.grey)),
